...
internal class WebViewWalletKitEngine private constructor(
    ...
    override suspend fun getNfts(walletAddress: String, limit: Int, offset: Int): io.ton.walletkit.model.TONNFTItems {
        ...
        val nftItems = json.decodeFromString<io.ton.walletkit.model.TONNFTItems>(result.toString())
    ...
    override suspend fun getJettons(walletAddress: String, limit: Int, offset: Int): io.ton.walletkit.model.TONJettonWallets {
        ...
        if (jettonsArray == null) {
            ...
            return io.ton.walletkit.model.TONJettonWallets(
                items = emptyList(),
                addressBook = null,
                metadata = null,
                pagination = null,
        ...
        val jettonWallets = mutableListOf<io.ton.walletkit.model.TONJettonWallet>()
        ...
        for (i in 0 until jettonsArray.length()) {
            ...
            val jettonInfo = io.ton.walletkit.model.TONJetton(
            ...
            val jettonWallet = io.ton.walletkit.model.TONJettonWallet(
    ...
    override suspend fun getTransactionPreview(
        ...
        return json.decodeFromString(
            io.ton.walletkit.model.TONTransactionPreview.serializer(),
            result.toString(),
        )
    }
        ...
        return when (type) {
            ...
            EventTypeConstants.EVENT_DISCONNECT -> {
                ...
                TONWalletKitEvent.Disconnect(
                    io.ton.walletkit.event.DisconnectEvent(sessionId),
                )
            }
...
/**
 * Internal helper to get the TonConnectInjector from a WebView.
 */
