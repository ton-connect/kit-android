...
object WalletKitEngineFactory {
        ...
        return when (kind) {
            ...
            WalletKitEngineKind.QUICKJS -> {
                try {
                    ...
                    Class.forName("io.ton.walletkit.bridge.impl.QuickJsWalletKitEngine")
                    true
    ...
    private fun createWebViewEngine(context: Context): WalletKitEngine {
        ...
        return io.ton.walletkit.bridge.impl.WebViewWalletKitEngine(context)
    }
    ...
    private fun createQuickJsEngine(context: Context): WalletKitEngine {
        try {
            ...
            val clazz = Class.forName("io.ton.walletkit.bridge.impl.QuickJsWalletKitEngine")
